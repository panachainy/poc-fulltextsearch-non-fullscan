INSERT INTO article_fulltexts (title, body) VALUES
...
-- Generate 1990 more records
INSERT INTO article_fulltexts (title, body)
SELECT
    CONCAT('Article ', n, ': ',
        CASE (n % 20)
...
FROM (
    ...
    WHERE a.N + b.N * 10 + c.N * 100 + d.N * 1000 BETWEEN 1 AND 1990
) numbers;
